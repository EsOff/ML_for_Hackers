...
# In this case we are not interested in classifying SPAM or HAM, so we will take
...
# Calculate the frequency of correspondence with all e-mailers in the training set
...
# sender, and a log-weight for that sender based on the frequency of correspondence.
